...
function Navbar() {
  ...
  return (
    <div className="">
      <div className="flex justify-end p-5 bg-gradient-to-r from-green-500 to-blue-500">
        <div className="flex gap-[1rem] text-2xl">
          ...
          {user && (
            <>
              <h1 className="h-[40px]  flex justify-center items-center">Welcome, {user.displayName}</h1>
              <button
                onClick={logout}
